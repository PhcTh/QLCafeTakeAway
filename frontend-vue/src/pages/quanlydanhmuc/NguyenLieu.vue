...
async function taiDuLieu() {
  try {
    dsNguyenLieu.value = await csharpApi.getNguyenLieu(tuKhoa.value)
...
function taoMaNguyenLieu() {
  return taoMaTiepTheo(dsNguyenLieu.value, 'maNl', 'NL')
}
